...
class LocationCubit extends Cubit<LocationState> {
  ...
  void addMarkers(){
    shoppingMarkers = [
      Marker(width: 50, height: 50, point: LatLng(37.42796133580664, -122.085749655962), child: AnimationMarker("assets/svgs/cart.svg", key: keys[0])),
      Marker(width: 50, height: 50, point: LatLng(37.43296265331129, -122.08833357075216), child: AnimationMarker("assets/svgs/cart.svg", key: keys[1])),
      Marker(width: 50, height: 50, point: LatLng(37.430007358400614, -122.09279406716532), child: AnimationMarker("assets/svgs/cart.svg", key: keys[2])),
      Marker(width: 50, height: 50, point: LatLng(37.42101562316406, -122.08999255963044), child: AnimationMarker("assets/svgs/cart.svg", key: keys[3])),
      Marker(width: 50, height: 50, point: LatLng(37.42096559667973, -122.08279533660888), child: AnimationMarker("assets/svgs/cart.svg", key: keys[4])),
    ];
    cycleMarkers = [
      Marker(width: 50, height: 50, point: LatLng(37.428648, -122.086720), child: AnimationMarker("assets/svgs/cycle.svg", key: keys1[0])),
      Marker(width: 50, height: 50, point: LatLng(37.431594, -122.086623), child: AnimationMarker("assets/svgs/cycle.svg", key: keys1[1])),
      Marker(width: 50, height: 50, point: LatLng(37.426085, -122.086816), child: AnimationMarker("assets/svgs/cycle.svg", key: keys1[2])),
      Marker(width: 50, height: 50, point: LatLng(37.428553, -122.089297), child: AnimationMarker("assets/svgs/cycle.svg", key: keys1[3])),
      Marker(width: 50, height: 50, point: LatLng(37.427845, -122.081855), child: AnimationMarker("assets/svgs/cycle.svg", key: keys1[4])),
    ];
    restroMarkers = [
      Marker(width: 50, height: 50, point: LatLng(37.42400833753989, -122.08810280177167), child: AnimationMarker("assets/svgs/rastaurant.svg", key: keys2[0])),
      Marker(width: 50, height: 50, point: LatLng(37.42840990932159, -122.09408761645678), child: AnimationMarker("assets/svgs/rastaurant.svg", key: keys2[1])),
      Marker(width: 50, height: 50, point: LatLng(37.427286128360564, -122.08070285849107), child: AnimationMarker("assets/svgs/rastaurant.svg", key: keys2[2])),
      Marker(width: 50, height: 50, point: LatLng(37.4324600632365, -122.08656974579321), child: AnimationMarker("assets/svgs/rastaurant.svg", key: keys2[3])),
      Marker(width: 50, height: 50, point: LatLng(37.43054036442099, -122.07695866408214), child: AnimationMarker("assets/svgs/rastaurant.svg", key: keys2[4])),
    ];
